...
trt_grid <- tibble(
  ...
  mutate(fecundity = 5) %>% ## more or less arbitrary, close to Trichogramma conditions given their sex ratio of about 50% and assuming 24 or 48 h of egg laying, as in experiments, see manuscript
