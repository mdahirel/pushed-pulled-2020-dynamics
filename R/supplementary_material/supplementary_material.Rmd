...
The two parameters $\mu_{i,t=0}$ (initial diversity) and  $\lambda_{x,i}$ (rate of decline) depend on replicate, treatment (reference or reduced connectivity) and location (core $x = 0$ or edge $x = 1$) as follow:
...
$$
in which the patch-level random effects $\alpha$ and $\gamma$ are correlated and distributed as follow:
