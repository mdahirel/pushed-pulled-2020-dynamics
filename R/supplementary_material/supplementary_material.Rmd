...
The two parameters $\mu_{i,t=0}$ (initial diversity) and  $\lambda_{x,i}$ (rate of decline) depend on replicate, treatment (reference or reduced connectivity) and location (core $x = 0$ or front $x = 1$) as follow:
...
The expansion speed $v_{i,t}$ can then be modelled as following:
