...
edgecorePalette <- c("#f1a340","#998ec3") # 3 colors, for core, front and origin (black) patches
...
```{r}
tibble(treatment=c("reference","restricted connectedness"),
       xstart=c(0.5,2),
       xend=c(1.5,3),
       expected=c(0.2,0.1),
...
ggplot()+
  ...
  scale_x_continuous("",lim=c(0.5,4),breaks=c(1,2.5),labels=c("reference","restricted connectedness"))+
  theme_half_open(11)+
  background_grid(colour.major = "grey95",colour.minor = "grey95")+
