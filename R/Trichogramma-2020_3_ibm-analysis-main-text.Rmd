...
data_genetics %>% ungroup() %>% 
  ...
  ggplot()+
  stat_eye(aes(x=K,fill=is.front,group=is.front,y=.value),position="dodge",normalize="xy")+
  ...
  scale_fill_manual("Location",labels=c("core","front"),values=c("#56B4E9","#E69F00"))+
  #scale_colour_manual("Location",labels=c("core","front"),values=c("#56B4E9","#E69F00"))+
  theme_bw()
```
