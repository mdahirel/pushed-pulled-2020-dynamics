...
###import raw datasets
raw_dynamics<- read_delim("D:/Maxime/Documents/POSTDOC INRA SOPHIA/DYNAMIQUES/RAWRESULTS_obs.txt",
                     "\t", escape_double = FALSE, col_types = cols(Pbis = col_number()), trim_ws = TRUE)

raw_genetics <- read_delim("D:/Maxime/Documents/POSTDOC INRA SOPHIA/GENET/Tricho_Aline_G0_G4_G8_G12.csv", 
                   ";", escape_double = FALSE, col_types = cols(P100 = col_character(), 
                                                                P112 = col_character(), P15 = col_character(), 
                                                                P17 = col_character(), P24 = col_character(), 
                                                                P39 = col_character(), P45 = col_character(), 
                                                                P73 = col_character(), P75 = col_character(), 
                                                                P76 = col_character(), P84 = col_character(), 
                                                                P99 = col_character()), trim_ws = TRUE)
...
## there are other way to do it (see e.g. stringr::str_pad()) but best to do it right at the outset
```
